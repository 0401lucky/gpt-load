export default {
  ...
  group: {
    ...
    usage: {
      ...
      stale: 'Model usage may be out of date; the background refresh failed.',
      refresh: 'Refresh usage',
      retry: 'Reload',
      emptyTitle: 'No model usage yet',
      emptyDescription: 'This group has no (credential, model) pairs in the counted range.',
      emptyFilterTitle: 'No pair matches the filters',
      emptyFilterDescription: 'Turn off "Cooling only" and try again.',
      onlyCooling: 'Cooling only',
      groupByModel: 'Group by model',
      groupCount: '{count} rows',
      caption: 'Credential × model usage matrix for this group',
      scrollHint: 'Scroll horizontally to see every column',
      columns: {
      ...
      cooldownUntil: 'available {time} ({remaining})',
      none: '—',
    },
  },
} as const
