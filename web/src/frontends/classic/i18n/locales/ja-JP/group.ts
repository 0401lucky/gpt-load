export default {
  ...
  group: {
    ...
    usage: {
      ...
      stale: 'モデル使用量が古い可能性があります。バックグラウンド更新に失敗しました。',
      refresh: '使用量を更新',
      retry: '再読み込み',
      emptyTitle: 'モデル使用量はまだありません',
      emptyDescription: '集計期間内にこのグループの（認証情報, モデル）の組み合わせはありません。',
      emptyFilterTitle: '条件に一致する組み合わせはありません',
      emptyFilterDescription: '「クールダウンのみ」を解除して再試行してください。',
      onlyCooling: 'クールダウンのみ',
      groupByModel: 'モデルでまとめる',
      groupCount: '{count} 件',
      caption: 'このグループの認証情報 × モデル使用量',
      scrollHint: '横にスクロールするとすべての列を表示できます',
      columns: {
        credential: '認証情報',
        model: '上流モデル',
        tokens: '期間内トークン',
      ...
      cooling: 'クールダウン中',
      cooldownUntil: '{time} に復帰（{remaining}）',
      none: '—',
    },
  },
} as const
