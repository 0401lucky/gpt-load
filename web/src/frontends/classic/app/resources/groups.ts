...
function projectRuntimeConfig(
  ...
  if (complete || Object.prototype.hasOwnProperty.call(record, 'rate_limit_reset_hint_enabled')) {
    result.rate_limit_reset_hint_enabled = projectBoolean(record.rate_limit_reset_hint_enabled)
  }
